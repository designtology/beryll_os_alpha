...
{
    internal class CrossSectionStdShaderGUI : ShaderGUI
{
	...
	static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
	{
        ...
        material.EnableKeyword("CLIP_PLANE");//if we want the primary section plane to appear in material preview
        material.DisableKeyword("CLIP_TWO_PLANES");//
